...
#ifndef _PRIMTIIVE_MANAGER_H_
#define _PRIMTIIVE_MANAGER_H_
...
class CPrimitiveManager : public CD3DXResourceGroup
{
private:
	//Base description.
...
public:
	CPrimitiveManager(void);
	virtual ~CPrimitiveManager(void);
