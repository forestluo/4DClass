...
// Desc:
//-----------------------------------------------------------------------------
VOID CD3DArcBall2::SetWindow( int iWidth, int iHeight, float fRadius )
{
    // Set ArcBall info
    m_iWidth  = iWidth;
    m_iHeight = iHeight;
...
// Desc:
//-----------------------------------------------------------------------------
D3DXVECTOR3 CD3DArcBall2::ScreenToVector( int sx, int sy )
{
    // Scale to screen
...
// Desc:
//-----------------------------------------------------------------------------
VOID CD3DArcBall2::SetRadius( FLOAT fRadius )
{
...
//-----------------------------------------------------------------------------
LRESULT CD3DArcBall2::HandleMouseMessages( HWND hWnd, UINT uMsg, WPARAM wParam,
                                          LPARAM lParam )
{
