...
///////////////////////////////////////////////////////////////////////////////
//
// CD3DXClassicCorkscrewJointObjectProxy
//
// Default construction.
//
///////////////////////////////////////////////////////////////////////////////

CD3DXClassicCorkscrewJointObjectProxy::CD3DXClassicCorkscrewJointObjectProxy(CD3DXJointObject* joint)
	: CD3DXJointObjectProxy(joint)
{
#ifdef _DEBUG
	assert(joint != _NULL);
	assert(joint->getJointType() == CJointAttribute::classicCorkscrewJoint);
#endif
}
...
CD3DXClassicCorkscrewJointObjectProxy::~CD3DXClassicCorkscrewJointObjectProxy(void)
{
...
void CD3DXClassicCorkscrewJointObjectProxy::setupCommonObjects(CListNodeEnumeration& iterator)
{
	//Renderable object.
	...
	//Scale it.
	object->setScale(C4DVector3(0.04f,length + 0.24f,0.04f));
...
HRESULT CD3DXClassicCorkscrewJointObjectProxy::createCommonObjects(CResourceManager* resourceManager)
{
	//Primitive object.
	...
	//Scale it.
	object->setScale(0.04f,0.24f,0.04f);
	//Set color.
	...
	object->setRotatable(_FALSE);
	//Scale it.
	object->setScale(0.048f,0.20f,0.048f);
	//Set color.
