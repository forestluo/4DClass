...
///////////////////////////////////////////////////////////////////////////////
//
// CD3DXClassicHingeJointObjectProxy
//
// Default construction.
//
///////////////////////////////////////////////////////////////////////////////

CD3DXClassicHingeJointObjectProxy::CD3DXClassicHingeJointObjectProxy(CD3DXJointObject* joint)
	: CD3DXJointObjectProxy(joint)
{
#ifdef _DEBUG
	assert(joint != _NULL);
	assert(joint->getJointType() == CJointAttribute::classicHingeJoint);
#endif
}
...
CD3DXClassicHingeJointObjectProxy::~CD3DXClassicHingeJointObjectProxy(void)
{
...
void CD3DXClassicHingeJointObjectProxy::setupCommonObjects(CListNodeEnumeration& iterator)
{
	//Renderable object.
...
HRESULT CD3DXClassicHingeJointObjectProxy::createCommonObjects(CResourceManager* resourceManager)
{
	//Primitive object.
