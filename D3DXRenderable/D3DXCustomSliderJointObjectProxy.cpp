...
///////////////////////////////////////////////////////////////////////////////
//
// CD3DXCustomSliderJointObjectProxy
//
// Default construction.
//
///////////////////////////////////////////////////////////////////////////////

CD3DXCustomSliderJointObjectProxy::CD3DXCustomSliderJointObjectProxy(CD3DXJointObject* joint)
	: CD3DXJointObjectProxy(joint)
{
#ifdef _DEBUG
	assert(joint != _NULL);
	assert(joint->getJointType() == CJointAttribute::customSliderJoint);
#endif
}
...
CD3DXCustomSliderJointObjectProxy::~CD3DXCustomSliderJointObjectProxy(void)
{
...
void CD3DXCustomSliderJointObjectProxy::setupCommonObjects(CListNodeEnumeration& iterator)
{
...
HRESULT CD3DXCustomSliderJointObjectProxy::createCommonObjects(CResourceManager* resourceManager)
{
	//Primitive object.
