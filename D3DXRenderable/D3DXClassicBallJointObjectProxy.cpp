///////////////////////////////////////////////////////////////////////////////
//
// D3DXClassicBallJointObjectProxy.cpp
//  
// 4DClass Developer
...
///////////////////////////////////////////////////////////////////////////////
//
// CD3DXClassicBallJointObjectProxy
//
// Default construction.
//
///////////////////////////////////////////////////////////////////////////////

CD3DXClassicBallJointObjectProxy::CD3DXClassicBallJointObjectProxy(CD3DXJointObject* joint)
	: CD3DXJointObjectProxy(joint)
{
#ifdef _DEBUG
	assert(joint != _NULL);
	assert(joint->getJointType() == CJointAttribute::classicBallJoint);
#endif
}
...
CD3DXClassicBallJointObjectProxy::~CD3DXClassicBallJointObjectProxy(void)
{
...
void CD3DXClassicBallJointObjectProxy::setupChildObjects(CListNodeEnumeration& iterator)
{
	//Renderable object.
...
void CD3DXClassicBallJointObjectProxy::setupParentObjects(CListNodeEnumeration& iterator)
{
	//Renderable object.
	CD3DXRenderableObject* object;
...
HRESULT CD3DXClassicBallJointObjectProxy::createChildObjects(CResourceManager* resourceManager)
{
	//Primitive object.
...
HRESULT CD3DXClassicBallJointObjectProxy::createParentObjects(CResourceManager* resourceManager)
{
	//Primitive object.
	CD3DXPrimitiveObject* object;
