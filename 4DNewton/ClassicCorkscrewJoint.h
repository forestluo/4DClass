...
#ifndef _CLASSIC_CORKSCREW_JOINT_H_
#define _CLASSIC_CORKSCREW_JOINT_H_
...
///////////////////////////////////////////////////////////////////////////////
//
// ClassicCorkscrewJoint
//
///////////////////////////////////////////////////////////////////////////////

class CClassicCorkscrewJoint : public CPhysicsClassicJoint
{
	friend unsigned ApplyCorkscrewCallBack(const NewtonJoint* corkscrew,NewtonHingeSliderUpdateDesc* desc);

public:
	CClassicCorkscrewJoint(void);
	virtual ~CClassicCorkscrewJoint(void);
...
///////////////////////////////////////////////////////////////////////////////
#endif //_CLASSIC_CORKSCREW_JOINT_H_
