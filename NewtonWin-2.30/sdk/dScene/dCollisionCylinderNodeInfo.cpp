...
dCollisionCylinderNodeInfo::dCollisionCylinderNodeInfo(dScene* world) 
...
dCollisionCylinderNodeInfo::dCollisionCylinderNodeInfo(NewtonCollision* cylinder)
	:dCollisionNodeInfo () 
{
...
void dCollisionCylinderNodeInfo::CalculateInertiaGeometry (dScene* world, dVector& inertia, dVector& centerOfMass) const
{
...
void dCollisionCylinderNodeInfo::Serialize (TiXmlElement* rootNode) const
{
...
bool dCollisionCylinderNodeInfo::Deserialize (TiXmlElement* rootNode, int revisionNumber) 
{
...
void dCollisionCylinderNodeInfo::SerializeBinary (FILE* file) 
{
_ASSERTE (0);
...
void dCollisionCylinderNodeInfo::DrawWireFrame(dScene* const world, dScene::dTreeNode* const myNode, const dVector& color) const
{
...
void dCollisionCylinderNodeInfo::DrawSolidWireFrame(dScene* const world, dScene::dTreeNode* const myNode, const dVector& color) const
{
	_ASSERTE (world->GetInfoFromNode(myNode) == this);
	_ASSERTE (myNode == world->Find(GetUniqueID()));
_ASSERTE (0);
...
void dCollisionCylinderNodeInfo::DrawGouraudShaded(dScene* const world, dScene::dTreeNode* const myNode, const dVector& color) const
{
	_ASSERTE (world->GetInfoFromNode(myNode) == this);
	_ASSERTE (myNode == world->Find(GetUniqueID()));
...
dCollisionCylinderNodeInfo::dGizmoHandle dCollisionCylinderNodeInfo::GetHighlightedGizmoHandle(
	dScene* world, 
...
void dCollisionCylinderNodeInfo::DrawGizmoHandle(dScene* world, const dMatrix& coordinaSystem, dGizmoMode mode, dGizmoHandle handle, const dVector& color, dFloat size) const
{
_ASSERTE (0);
...
void dCollisionCylinderNodeInfo::DrawGizmo(
	dScene* world, 
	dScene::dTreeNode* myNode, 
	const dMatrix& coordinaSystem,
	const dVector& color, 
