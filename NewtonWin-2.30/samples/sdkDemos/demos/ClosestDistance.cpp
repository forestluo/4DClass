...
{
	public:
	ClosestDistanceNode (NewtonBody* body, NewtonCollision* castShape, DemoEntityManager* scene)
		:DemoEntity (NULL)
	{
...
void ClosestDistance (DemoEntityManager* scene)
{
	...
	dVector origin (0.0f, 10.0f, 80.0f, 0.0f);
